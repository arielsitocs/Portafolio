...
import WritterPhrase from "./ui/Phrase";

export default function Landing() {
  return (
    <section id="landing" className="w-full min-h-[100vh] bg-landing-gradient px-4 xl:px-44 py-30 lg:py-44 flex flex-col border-b-3 border-gray-background">
      <div className="text-white font-semibold">
        <h1 className="text-[clamp(24px,3vw,30px)]">Desarrollador Web dedicado a ser</h1>
        <h1 className="text-[clamp(24px,3vw,30px)] mt-[-7px] mb-2"><span className="text-primary-blue [text-shadow:0_0_10px_var(--primary-blue)]">FullStack</span> & <span className="text-light-primary-red  [text-shadow:0_0_10px_var(--light-primary-red)]">FreeLancer.</span></h1>
      ...
      <div className="flex gap-3 mt-5 mb-10 md:mb-10">
      ...
      <div className="flex items-center">
        <div className="grid grid-cols-[100%] w-full  lg:grid-cols-[300px_300px] gap-6 ">
        ...
        <div className="hidden lg:flex flex-col ml-[5%]  w-full">
            <WritterPhrase />
        </div>
      </div>
    </section>
